...
<style>
    ...
    */
    ...
    body { background: linear-gradient(90deg, rgba(77,76,89,1) 34%, rgba(2,0,36,1) 93%);}
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form method="post" action="{{ url('invite') }}">
                @csrf
                <h4 style="color: white">Enter Email for invitation</h4>
                ...
                <button type="submit" class="btn btn-danger cancel-button" onclick="parent.window.close();">Cancel</button>
            </form>
        </div>
    </div>
